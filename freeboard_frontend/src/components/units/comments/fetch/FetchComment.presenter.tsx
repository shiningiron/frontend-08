      ...
      {props.data?.fetchBoardComments.map((el) => (
        <Cmt.Box key={el._id}>
          <Cmt.WriterInfoBox>
            ...
            <Cmt.ProfileBox>
              <Cmt.ProfileWriter>{el.writer}</Cmt.ProfileWriter>
              <Cmt.ProfileCreatedTime>{el.createdAt}</Cmt.ProfileCreatedTime>
            </Cmt.ProfileBox>
          </Cmt.WriterInfoBox>
          <Cmt.CommentContents>{el.contents}</Cmt.CommentContents>
          <Cmt.Tools>
            <Cmt.DeleteTool
              id={el._id}
